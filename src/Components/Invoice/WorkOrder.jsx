...
const WorkOrder = () => {
	...
	const updatePdfLink = async () => {
		...
		axios.put(`${process.env.REACT_APP_BACKEND_URL}/slips/updateWorkOrder/${workOrderId}`, data, {
			headers: {
	...
	const handleGenerate = async () => {
		try {
			if (!workOrderId) {
				const res = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/slips/getWorkOrderId`, {}, {
					headers: {
						Authorization: `Bearer ${localStorage.getItem('admin-token')}`,
						"Content-Type": "application/json",
					}
				...
				console.log('id generated :', res.data.workorderId);
			}
		} catch (err) {
			console.log(err);
		}
		...
		<div style={styles.container}>
			{!form &&
				<>
					...
					<h1 style={{ textAlign: 'center', marginBottom: '4rem' }}>Work Order Form</h1 >
					<form onSubmit={handleSubmit} style={{ display: 'grid', gap: '15px' }}>
						{/* Row -2 */}
						<div style={styles.row}>
							<div style={styles.column}>
								<label style={styles.label}>CIN No:</label>
								<input style={styles.input} type="text" name="cin" value={formData.cin} onChange={handleChange} required/>
							</div>
							<div style={styles.column}>
						...
						<div style={styles.row}>
							<div style={styles.column}>
								...
								<input style={styles.input} type="text" name="pf" value={formData.pf} onChange={handleChange} required/>
							</div>
							<div style={styles.column}>
								<label style={styles.label}>ESIC No:</label>
								<input style={styles.input} type="text" name="esic" value={formData.esic} onChange={handleChange} required/>
							</div>
						</div>
						{/* Row 0 */}
						<div style={styles.row}>
							<div style={styles.column}>
								...
								<textarea style={styles.textarea} name="billingAddress" value={formData.billingAddress} onChange={handleChange} required/>
							</div>
							<div style={styles.column}>
								<label style={styles.label}>Shipment Address:</label>
								<textarea style={styles.textarea} name="shipmentAddress" value={formData.shipmentAddress} onChange={handleChange} required/>
							</div>
						</div>
						{/* Row 1 */}
						<div style={styles.row}>
							<div style={styles.column}>
								...
								<input style={styles.input} type="date" name="poDate" value={formData.poDate} onChange={handleChange} required/>
							</div>
						</div>
						...
						<div style={styles.row}>
							<div style={styles.column}>
								...
								<input style={styles.input} type="date" name="deliveryDate" value={formData.deliveryDate} onChange={handleChange} required/>
							</div>
							<div style={styles.column}>
								<label style={styles.label}>Vendor Name:</label>
								<input style={styles.input} type="text" name="vendorName" value={formData.vendorName} onChange={handleChange} required/>
							</div>
						</div>
						...
						<div style={styles.row}>
							<div style={styles.column}>
								...
								<input style={styles.input} type="text" name="warranty" value={formData.warranty} onChange={handleChange} required/>
							</div>
							<div style={styles.column}>
								<label style={styles.label}>Vendor Address:</label>
								<textarea style={styles.textarea} name="vendorAddress" value={formData.vendorAddress} onChange={handleChange} required/>
							</div>
						</div>
						...
						<div style={styles.row}>
							<div style={styles.column}>
								...
								<input style={styles.input} type="text" name="paymentTerms" value={formData.paymentTerms} onChange={handleChange} required/>
							</div>
							<div style={styles.column}>
								<label style={styles.label}>Delivery Terms:</label>
								<input style={styles.input} type="text" name="deliveryTerms" value={formData.deliveryTerms} onChange={handleChange} required/>
							</div>
						</div>
						...
						<div style={styles.row}>
							<div style={styles.column}>
								...
								<input style={styles.input} type="text" name="freight" value={formData.freight} onChange={handleChange} required/>
							</div>
							<div style={styles.column}>
						...
						<div style={styles.row}>
							<div style={styles.column}>
								...
								<input style={styles.input} type="number" name="quantity" value={formData.quantity} onChange={handleChange} min={0}required/>
							</div>
							<div style={styles.column}>
						...
						<div style={styles.row}>
							<div style={styles.column}>
								...
								<input style={styles.input} type="number" name="igst" value={formData.igst} onChange={handleChange} min={0}required/>
							</div>
							<div style={styles.column}>
								<label style={styles.label}>Net Amount:</label>
								<input style={styles.input} type="text" name="netAmount" value={formData.netAmount} readOnly required/>
							</div>
						</div>
					...
					<div id="purchase-order" style={{ padding: "30px 10px" }}>
						...
						<table style={{ width: '100%', borderCollapse: 'collapse', margin: '0 auto' }}>
							...
							<tr>
								...
								<td colSpan="2" style={{ border: '1px solid black', padding: '6px' }}>{workOrderId}</td>
